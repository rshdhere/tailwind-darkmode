...
const icons = [
  ...
  },
  {
    title: "OpenAI",
    circle: "circle-2",
    icon: <OpenAILogo className="size-8" />,
  },
  {
    title: "Meta",
    circle: "circle-3",
  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      <div className="relative z-10 h-80 w-60 overflow-hidden rounded-xl border border-neutral-100 bg-neutral-50 shadow-2xl dark:border-neutral-800 dark:bg-neutral-900">
        <div className="mask-t-from-50% mask-r-from-50% mask-b-from-50% mask-l-from-50%">
          <Pattern />
        ...
        <div className="p-4">
          <h2 className="text-[10px] font-bold text-neutral-600">
          ...
          <button
            ...
            className="mt-4 cursor-pointer rounded-lg bg-neutral-100 px-2 py-1 text-[10px] text-black dark:bg-neutral-800"
          >
